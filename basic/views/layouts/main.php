                ...
                <div class="ddnewhead_operate" dd_name="顶链接">
                    <div>
                        <ul class="ddnewhead_operate_nav">
                            <li><a target="_blank" href="/site/about">关于我们</a></li>
                            <li><a target="_blank" href="/site/contact">建议箱</a></li>
                        </ul>
                        <div class="new_head_znx" id="znx_content" style="display:none;"></div>
                        <div class="ddnewhead_welcome" display="none;">
                            <span id="nickname">请<a dd_name="登录" href="/site/login" target="_self" rel="nofollow" class="login_link">登录</a><a dd_name="成为会员" href="javascript:PageTopRegist();" target="_self" rel="nofollw">成为书吧的一员</a></span>
                        </div>
                    </div>
                    <div class="welcome">
                        欢迎光临，小巧玲珑书吧
            ...
            <div class="logo_line" dd_name="搜索框">
                ...
                <div class="search_bottom">
                    <div class="search_hot">热搜:
                        <a href="?hotword=dygw" name="hotword">东野圭吾</a>
                        <a href="?hotword=ajs" name="hotword">阿加莎克里斯蒂</a>
                        <a href="?hotword=xwz" name="hotword">小王子</a>
                    </div>
                ...
                <div class="nav_top" dd_name="一级导航条">
                    <ul>
                        <li><a name="nav1" href="#" target="_blank">图书</a></li>
                ...
                <div class="ddnew_cart"><a name="购物车" href="/site/cart" dd_name="购物车"><i class="icon_card"></i>购物车<b id="cart_items_count">0</b></a></div>
                <div class="ddnew_order">
                    <a target="_blank" href="/site/order" name="我的订单" dd_name="我的订单" rel="nofollow">我的订单<b id="unpaid_num" style="color:#ff2832;font:bold 12px Arial;"></b></a>
                </div>
            </div>
        </div>
    </div>
